...
export function NavList({theme, subMenuName, handleClick}: {
	theme: string; 
	...
	const classes = "w-full block text-left p-3";
	const liClasses = "relative";
	...
	return (
		<div className="flex">
			...
			<nav className="flex-none">
				<ul className="flex inline-flex flex-row">
